    ...
    <>
      ...
      >
        ...
        />
         ...
         <div className="absolute bottom-0 left-0 right-0 bg-black w-full py-4 lg:py-6">
          <div className="px-4 lg:px-24 flex justify-between items-center max-w-[1440px] mx-auto">
            <img src="/versace-collection.png" alt="Versace" className="h-4 lg:h-[33px] w-auto" />
            <img src="/zara-collection.png" alt="zara" className="h-4 lg:h-[38px] w-auto" />
            <img src="/gucci-collection.png" alt="Gucci" className="h-4 lg:h-[36px] w-auto" />
            <img src="/prada-collection.png" alt="prada-collection" className="h-4 lg:h-[31px] w-auto" />
            <img src="/calvin-collection.png" alt="calvin-collection" className="h-4 lg:h-[33px] w-auto" />
          </div>
        </div>
      </div>
